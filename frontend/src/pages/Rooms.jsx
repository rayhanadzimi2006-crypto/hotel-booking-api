...
export default function Rooms() {
  ...
  const [form, setForm] = useState({ room_number: '', room_type_id: '', status: 'tersedia' });
      ...
      render: (value) => (
        <span
          style={{
            ...
            fontSize: '12px',
            fontWeight: '600',
            backgroundColor: value === 'tersedia' ? '#d4edda' : value === 'terisi' ? '#f8d7da' : '#fff3cd',
            color: value === 'tersedia' ? '#155724' : value === 'terisi' ? '#721c24' : '#856404',
          }}
        >
          {value}
        </span>
  ...
  const openAddModal = () => {
    setEditing(null);
    setForm({ room_number: '', room_type_id: '', status: 'tersedia' });
    setModalOpen(true);
  };
    ...
    <div>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.pageSubtitle}>Kelola data kamar hotel</p>
        </div>
      ...
      <Modal
        ...
        title={editing ? 'Edit Room' : 'Tambah Room'}
      >
