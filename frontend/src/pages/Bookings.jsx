...
export default function Bookings() {
  ...
  const columns = [
    ...
    },
    {
      key: 'room',
      label: 'Kamar',
      render: (value) => value?.room_number || '-',
    },
    ...
    <div>
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.pageSubtitle}>Kelola data pemesanan kamar</p>
        </div>
      ...
      <Modal
        ...
        title={editing ? 'Edit Booking' : 'Tambah Booking'}
      >
            ...
            >
              ...
              {rooms.map((r) => (
                <option key={r.id} value={r.id}>
                  {r.room_number} - {r.room_type?.type_name}
                </option>
              ))}
            </select>
          </div>
